...
## What drove this:
I was attempting to get GPU support under Unraid on a Dell PowerEdge R920 quad-socket server, after much pain I found Dell's half-broken UEFI implementation was the only way to get proper MMIO for the Nvidia driver to initialize without error.
